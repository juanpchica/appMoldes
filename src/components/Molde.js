            ...
            <Form>
                <Form.Row>
                    <Form.Group as={Col}>
                        ...
                        <Form.Control type="text" value={molde.dimensiones} onChange={(e)=>{setMolde({...molde,dimensiones:e.target.value})}} />
                    </Form.Group>

                    <Form.Group as={Col}>
                        <Form.Label>Tipo</Form.Label>
                        <Form.Control type="text" value={molde.tipo} onChange={(e)=>{setMolde({...molde,tipo:e.target.value})}} />
                    </Form.Group>
                </Form.Row>
                ...
                <Form.Row>
                    <Form.Group as={Col}>
                        ...
                        <Form.Control type="text" placeholder="Cantidad de Moldes:" value={molde.cantidad} onChange={(e)=>{setMolde({...molde,cantidad:e.target.value})}}/>
                    </Form.Group>
                ...
                <Form.Row>
                    <Form.Group as={Col}>
                        <Form.Check type="checkbox" label="Boquete" />
                    </Form.Group>

                    <Form.Group as={Col}>
                        <Form.Check type="checkbox" label="Soporte" />
                    </Form.Group>
